    ...
    <section className=" max-container">
      ...
      <div className='py-16'>
        ...
        <div className='mt-5 flex flex-col gap-3 text-slate-500'>
          <p>I've worked with all sort companies, leveling up my skills and teaming up with smart people. Here's the rundown:</p>
        </div>
        <div className='mt-12 flex'>
            ...
            {experiences.map((experience) => (
              ...
              icon={<div className='flex justify-center items-center w-full h-full'>
                ...
                <p className='text-black-500 font-medium font-base'style={{margin:0}}>{experience.company}</p>
